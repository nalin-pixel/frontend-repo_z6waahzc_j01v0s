    ...
    <section className="relative min-h-[80vh] w-full overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex max-w-6xl flex-col items-center px-6 pt-24 text-center sm:pt-28">
        <span className="mb-4 inline-flex items-center gap-2 rounded-full border border-blue-400/30 bg-blue-400/10 px-3 py-1 text-xs font-medium text-blue-200">
          ERFMS • Energy Renovation File Management SaaS
        </span>
        <h1 className="mb-4 bg-gradient-to-r from-white via-blue-100 to-blue-300 bg-clip-text text-4xl font-semibold tracking-tight text-transparent sm:text-6xl">
          Centralize files. Automate workflows. Delight clients.
        </h1>
        <p className="max-w-2xl text-blue-100/90">
          A back-office control center and a client-facing portal for CEE, Ma Prime Rénov', and energy audit workflows — all in one secure platform.
        </p>
        <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row">
          <a href="#preview" className="rounded-lg bg-blue-500 px-5 py-3 text-white shadow-lg shadow-blue-500/30 transition hover:bg-blue-400">View Live Preview</a>
          <a href="/test" className="rounded-lg border border-white/20 px-5 py-3 text-blue-100 transition hover:bg-white/10">Check Backend Status</a>
        </div>
      </div>
    </section>
  )
